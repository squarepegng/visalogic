    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <nav className="border-b bg-white p-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="font-bold text-xl text-blue-600">🚀 ReviewRocket</div>
          <div className="space-x-4">
            <Link href="/login" className="text-slate-600 hover:text-slate-900 font-medium">Login</Link>
            <Link href="/dashboard" className="bg-blue-600 text-white px-5 py-2 rounded-lg font-medium hover:bg-blue-700 transition">Get Started ($29/mo)</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4 py-20">
        <div className="inline-block bg-blue-100 text-blue-800 px-4 py-1.5 rounded-full text-sm font-semibold mb-6">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight max-w-4xl mb-6 leading-tight">
          Get 5-Star Reviews on <span className="text-blue-600">Autopilot.</span>
        </h1>
        ...
        <Link href="/dashboard">
          <button className="bg-blue-600 text-white px-8 py-4 rounded-xl text-lg font-bold shadow-lg hover:bg-blue-700 transition transform hover:scale-105">
