        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-1 text-sm font-medium text-slate-500">
              ...
              <Link href="#" className="px-3 py-1.5 hover:text-slate-900 transition">Settings</Link>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-8 w-8 bg-gradient-to-tr from-blue-600 to-indigo-600 rounded-full text-white flex items-center justify-center text-sm font-bold shadow-sm ring-2 ring-white cursor-pointer select-none">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex justify-between items-end mb-8">
          ...
          <button 
            ...
            className="hidden sm:flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm transition active:scale-95"
          >
        ...
        {/* Metrics Grid - Stripe Style Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] flex flex-col justify-between">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-xs font-semibold px-2 py-1 bg-green-50 text-green-700 rounded-full flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] overflow-hidden">
              ...
              <div className="p-6 bg-slate-50/50">
                <form onSubmit={handleSend} className="space-y-4">
                  <div>
                    <label htmlFor="phone-input" className="block text-sm font-medium text-slate-700 mb-1.5">
                  ...
                  {status === "success" && (
                    <div className="flex items-start gap-2 p-3 bg-green-50 text-green-700 rounded-lg text-sm font-medium border border-green-100 animate-in fade-in slide-in-from-top-2">
          ...
          {/* Right Column: Activity Feed / Table */}
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border border-slate-200 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] overflow-hidden">
              <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                <h2 className="text-lg font-semibold text-slate-900">Recent Activity</h2>
                <button className="text-sm font-medium text-blue-600 hover:text-blue-800 transition">View all</button>
              </div>
              
              {/* Empty State representing a modern data table */}
              <div className="p-12 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-slate-500 max-w-sm">
                  When you send a review request to a customer, it will appear here along with its delivery status.
                </p>
                <button 
                  onClick={() => document.getElementById('phone-input')?.focus()}
